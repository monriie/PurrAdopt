...
<html lang="id" class="scroll-smooth">
    ...
    <body class="font-[poppins] bg-gray-100 px-8 py-16 flex justify-center">
        <main class="bg-white shadow-md rounded-lg p-8 max-w-lg w-full">
            <h1 class="text-3xl font-bold text-center text-purple-700 mb-6">Mengupdate Struk Adopsi</h1>

            <form method="POST" class="space-y-4">
                <div>
                    <label class="block font-medium text-gray-700">Nama :</label>
                    <input type="text" name="name" value="<?= htmlspecialchars($adoption['name']) ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-purple-500 focus:border-purple-500" required>
                </div>

                <div>
                    <label class="block font-medium text-gray-700">Email :</label>
                    <input type="email" name="email" value="<?= htmlspecialchars($adoption['email']) ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-purple-500 focus:border-purple-500" required>
                </div>

                <div>
                    <label class="block font-medium text-gray-700">No HP :</label>
                    <input type="text" name="phone" value="<?= htmlspecialchars($adoption['phone']) ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-purple-500 focus:border-purple-500" required>
                </div>

                <div>
                    <label class="block font-medium text-gray-700">Jenis Kelamin :</label>
                    <select name="gender" class="w-full border border-gray-300 rounded-lg px-3 py-2  appearance-none focus:ring-purple-500 focus:border-purple-500">
                ...
                <div>
                    <label class="block font-medium text-gray-700">Jenis Kucing:</label>
                    <input type="text" readonly value="<?= htmlspecialchars($adoption['cat_name']) ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-100">
                </div>
